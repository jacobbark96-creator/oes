...
export const FundingSection: React.FC = () => {
  return (
    <section id="funding" className="py-16 md:py-20 lg:py-24 bg-white">
      <div className="container">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 lg:gap-20 items-center relative z-10">
